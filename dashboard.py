...
with st.sidebar:
	...
	st.text(
		...
		Berikut adalah dashboard sederhana yang coba saya buat dari data yang sudah saya analisis. Ini adalah data kualitas udara dari daerah Wanliu pada tahun 2017.
		)
